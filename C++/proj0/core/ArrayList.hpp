...
{
    try{
        items = new objectName[initialCapacity];
        sz = 0;
        cap = initialCapacity;
    }
    catch (...)
...
template <typename objectName>
ArrayList<objectName>::ArrayList(const ArrayList<objectName>& a)
{
    try{
        items = new objectName[a.cap];
...
template <typename objectName>
ArrayList<objectName>& ArrayList<objectName>::operator=(const ArrayList<objectName>& a)
{
...
void ArrayList<objectName>::add(const objectName& s)
{
    if (sz == cap)
    {
        ...
        objectName* newItems;
        try{
            newItems = new objectName[newCap];
