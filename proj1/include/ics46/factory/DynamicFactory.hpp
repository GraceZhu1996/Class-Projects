...
//
//     ICS46_DYNAMIC_FACTORY_REGISTER(MazeGenerator, MyCoolMazeGenerator, "My Cool Maze Generator");
//
...
//         ics46::DynamicFactory<MazeGenerator>::instance().make("My Cool Maze Generator");
//
// Or get a collection of all available types like this:
//
//     ics46::DynamicFactory<MazeGenerator>::instace().allRegisteredTypes()
//
