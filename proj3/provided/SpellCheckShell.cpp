...
namespace
{
        ...
        const std::string& wordFilePath, const std::string& textFilePath)
    {
        ...
        std::cout << std::right << std::fixed << std::setprecision(6) << std::setw(12)
                  << wordSetLoadDuration;
        
        std::cout << std::right << std::fixed << std::setprecision(6) << std::setw(19)
                  << wordSetSpellCheckDuration;
        ...
        std::cout << std::right << std::fixed << std::setprecision(6) << std::setw(12)
                  << emptySetLoadDuration;
        
        std::cout << std::right << std::fixed << std::setprecision(6) << std::setw(19)
                  << emptySetSpellCheckDuration;

        std::cout << std::right << std::fixed << std::setprecision(6) << std::setw(14)
                  << (emptySetLoadDuration + emptySetSpellCheckDuration);
        ...
        std::cout << std::right << std::fixed << std::setprecision(6) << std::setw(12)
                  << (wordSetLoadDuration - emptySetLoadDuration);
        
        std::cout << std::right << std::fixed << std::setprecision(6) << std::setw(19)
                  << (wordSetSpellCheckDuration - emptySetSpellCheckDuration);
